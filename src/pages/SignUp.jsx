...
export default function SignUp() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      toast.success("Sign up was successful and you are welcome!")
      navigate("/sign-in");
    } catch (error) {
  ...
  return (
    <section>
       <h1 className="text-3xl text-center text-yellow-800 mt-6 font-bold">Sign Up</h1>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form className='p-8' onSubmit={onSubmit}>
            ...
            <input type='text' id='name' value={name} onChange={onChange} placeholder='Enter your full name' className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 mb-4 rounded transition ease-in-out"/>
            ...
            <div className='flex justify-between text-center mt-6 whitespace-nowrap text-sm sm:text-lg'>
                <p className='mb-6 text-gray-700'>Already have an account? 
                  <Link to="/sign-in"  className='text-red-700 font-bold hover:underline hover:text-red-800 transition duration-200 ease-in-out ml-1'>Log In</Link>
                </p>
                <p>
            ...
            <button  className='w-full bg-blue-600 text-white px-7 py-3 text-sm rounded-md font-medium uppercase shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type='submit'>Sign Up</button>
