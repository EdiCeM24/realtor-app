    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form className='p-8'>
            <input type='text' id='text' value={name} onChange={onChange} placeholder='Enter your full name' className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 mb-4 rounded transition ease-in-out"/>
            ...
            <div className='flex justify-between text-center mt-6 whitespace-nowrap text-sm sm:text-lg'>
                <p className='mb-6 text-gray-700'>Already have an account? 
                  <Link to="/sign-up"  className='text-red-700 font-bold hover:underline hover:text-red-800 transition duration-200 ease-in-out ml-1'>Log In</Link>
                </p>
                <p>
